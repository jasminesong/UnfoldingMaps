...
public class HelloWorld extends PApplet
{
	...
	public void setup() {
		...
		//add code for gradient visual effect
		noStroke();
		...
		AbstractMapProvider _provider = new GeoMapApp.TopologicalGeoMapProvider();
		map2 = new UnfoldingMap(this,420,50,350,500,_provider);
		map2.zoomAndPanTo(zoomLevel, new Location(30.593826, 114.260511));
